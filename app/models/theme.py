...
class Theme(models.Model):
    ...
    primary = ColorField(default='#19b5fe', help_text="Most text, icons, and borders.")
    ...
    button_primary = ColorField(default='#19b5fe', help_text="Primary button color.")
    ...
    border = ColorField(default='#22a7f0',
                        help_text="The color of most borders.")
    highlight = ColorField(default='#f7f7f7', help_text="The background color of panels and some borders.")

    dialog_warning = ColorField(
        default='#e47833', help_text="The border color of warning dialogs.")
